...
As is shown in the table, there is no obvious trend. But there are two days that are abnormal,which are the Saturday of the 4th and 5th week. The activity count of every minute is 1. \## Make a single-panel plot that shows the 24-hour activity time courses for each day and use color to indicate day of the week.
...
As is shown in the plot, the activity count is mostly low during night and high during the day. It is especially high in the morning and evening. \# P3 \## import the data
