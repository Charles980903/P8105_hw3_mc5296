   ...
   theme(
     ...
     axis.title =  element_text(size=9,face = "bold"), # set the size of the xlabel
        axis.text.x = element_text(angle=70,  # rotate the xlabel
                                     hjust = 1)) # adjust the position of the xlabel text
```
Here I used line to show the trends of mean max temperature of January and JUly across the years. The range of mean max temperature in January is in a range of -10 ℃ to  10℃.  In  July, the range is  20  to 35.
